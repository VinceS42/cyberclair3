    ...
    return (
        <>
            ...
            <div className="container mx-auto px-4">
                <header className="text-center py-10 bg-gradient-to-r from-cyberSecondary to-cyberPrimary text-white">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <section className="bg-cyberSecondary text-white p-6 my-8 rounded-lg shadow-lg">
                            ...
                            <p className="text-lg mt-2">
                                Notre plateforme offre une solution proactive
                                dans la lutte contre le contenu indésirable...
                            </p>
                            ...
                            <p className="text-lg mt-2">
                                ...
                                rendant nos outils intuitifs et faciles à
                                utiliser pour chacun. Notre plateforme SaaS
                                élimine la complexité traditionnellement
                                associée à la gestion de la sécurité en ligne,
                                vous permettant de contrôler facilement votre
                                présence numérique avec confiance et sérénité.
                            </p>
                            ...
                            <p className="text-lg mt-2">
                                Nous adoptons une approche sans précédent pour
                                la sécurité des données, en intégrant les
                                dernières technologies de chiffrement et de
                                protection de la vie privée dès la conception de
                                nos services. Cela garantit que vos données
                                personnelles restent privées, sécurisées, et
                                sous votre contrôle total à tout moment.
                            </p>
                        </section>
                        ...
                        <section className="bg-cyberSecondary text-white p-6 my-8 rounded-lg shadow-lg">
                            ...
                            <ul className="list-disc list-inside text-lg text-white">
                                ...
                                <li>
                                    Analyse et gestion proactive de votre
                                    réputation numérique.
                                </li>
                                <li>
                                    Outils conviviaux pour une gestion
                                    simplifiée de votre identité en ligne.
                                </li>
                            </ul>
